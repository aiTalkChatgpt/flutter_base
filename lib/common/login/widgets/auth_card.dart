...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _nameController.text = SpUtil.getString(SpUtil.userName);
    _passController.text = SpUtil.getString(SpUtil.password);
  ...
  Widget _buildSubmitButton(ThemeData theme, LoginMessages messages, Auth auth) {
    return Container(
        ...
        color: BaseConstants.getAppMainColor(context),
        loadingColor: BaseConstants.getAppMainColor(context),
