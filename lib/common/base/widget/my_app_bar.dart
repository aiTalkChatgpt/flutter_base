...
import 'package:flutter_base/common/ui/tool/tool_page.dart';
...
class _MyAppBarState extends State<MyAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle centerStyle =
        widget.textTheme?.subtitle1 ?? themeData.primaryTextTheme.subtitle1;
    TextStyle sideStyle =
        widget.textTheme?.bodyText1 ?? themeData.primaryTextTheme.bodyText1;
      ...
      middle: Column(
        ...
        GestureDetector(
          onLongPress: (){
            String toTitle;
            try{
              DefaultTextStyle text = title;
              Semantics s = text.child;
              Text t = s.child;
              toTitle = t.data;
            }catch(e){
              toTitle ="$e";
            ...
            show(toTitle);
            navigateTo(context, ToolPage(toTitle));
          },
          child: title,),
          if(BaseConstants.isDebug && BaseConstants.isShowBarTool)
            InkWell(
              onTap: (){
                String toTitle;
                try{
              ...
              child: textStyle("${App?.topStackWidget}",fontSize: 12.0,color: ResColors.white),)
      ],),
      trailing: actions,
